...
namespace oni
{
    ...
    public:
        /**
         * @brief Button Constructor, with only back texture
        ...
        */
        ...
        /** 
         * @brief Button Constructor, with back texture, and front texture
        ...
        */
        ...
        /** 
         * @brief Button Constructor, with back texture, and text as front texture
         * @param backTexFilename The filename of the back texture to load
