...
{
public:
    //Button Constructer, with only back texture
    ...
    //Button Constructer, with back texture, and front texture
    ...
    //Button Constructer, with back texture, and text as front texture
    //@param backTexFilename The filename of the back texture to load
